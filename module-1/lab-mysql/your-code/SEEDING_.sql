/*USE coches;*/
INSERT INTO cars
(ID,car_vin,car_manufacturer,car_model,car_year,car_color)
...
(ID,cus_ID,cus_name,cus_phone,cmr_email,cmr_address,cmr_city,cmr_state,cmr_country,cmr_cp)
...
(ID, sal_staff,sal_name,sal_store)
...
(ID,inv_number,inv_date,inv_car,inv_customer,inv_sal_person)
